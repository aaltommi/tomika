export const main: Record<string, string> = {
    ...
    "main.info.location.desc": "Juhlapaikka sijaitsee Slovakiassa, Krasňanyn kylässä, osoitteessa Kaštieľ Krasňany, Krasňany 21, 013 01 Krasňany",

    "main.info.general": "Yleistä",
    ...
    "main.info.dresscode.desc": "Juhlapukeutuminen, Puku",

    "main.info.gifts": "Lahjatoive",
    "main.info.gifts.desc": "Tärkeintä on tietenkin, että pääset paikalle. Mikäli kuitenkin haluatte muistaa meitä, niin toivomme muistamiset yhteistä häämatkaamme varten tilille:",
    "main.info.gifts.iban": "IBAN: FI55 5630 4550 0424 27, Saaja: Tommi Aalto",
