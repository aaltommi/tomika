export const registration: Record<string, string> = {
    ...
    "registration.form.allergies": "Ruoka-allergiat ja erityisruokavaliot",
    ...
    "registration.form.preferences": "Mitä haluat syödä?",
    "registration.form.preferences.meat": "Liha",
    "registration.form.preferences.vegan": "Vegaaninen",
    "registration.form.preferences.fish": "Kala",
